'''
This file is used to test the functionality of the general search bar before deploying updates to the front end.
All of this code can be called by the search function in "backend_test.py"
