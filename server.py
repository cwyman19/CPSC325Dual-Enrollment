...
def get_time():
    ...
    #     }
    return {
        'name1': most_similar_courses[0][2],
      'description1': most_similar_courses[0][3],
      'name2': most_similar_courses[1][2],
      'description2': most_similar_courses[1][3],
      'name3': most_similar_courses[2][2],
      'description3': most_similar_courses[2][3],
        }
